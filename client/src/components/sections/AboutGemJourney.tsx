...
import { Pickaxe, Waves, Compass, Gem } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {gemJourney.steps.map((step, idx) => {
            ...
            return (
              <div
                key={idx}
                className="group relative bg-card border border-border/70 rounded-2xl overflow-hidden hover:border-primary/50 transition-colors flex flex-col justify-between"
              >
                ...
                <div className="p-5 space-y-3 flex-1 flex flex-col justify-between">
                  <div className="space-y-1.5">
                    ...
                    <h3 className="font-serif font-medium text-base text-foreground group-hover:text-primary transition-colors">
                      {step.title}
                    </h3>
