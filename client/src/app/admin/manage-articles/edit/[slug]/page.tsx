...
export default function EditArticlePage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const handleSave = async (e: React.FormEvent) => {
    ...
    // Validate Unique Slug (no duplicates)
    const allArticles = getStoredArticles();
    const isDuplicate = allArticles.some(a => a.slug === cleanSlug && a.id !== articleId);
    ...
    // Convert YYYY-MM-DD to friendly formatted string
  ...
  const isDuplicateSlug = getStoredArticles().some(a => a.slug === articleSlug && a.id !== articleId);
  ...
  return (
    <div className="space-y-6 w-full pb-20">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 border-b border-border/80 pb-5">
        ...
        <div className="flex items-center gap-3">
          <Button asChild variant="ghost" size="sm" className="text-xs gap-1.5 text-muted-foreground hover:text-primary">
          ...
          <Card className="bg-card border-border/80 shadow-sm">
            ...
            <CardContent className="space-y-4">
              <div className="space-y-1.5">
                ...
                <Input
                  required
                  placeholder="e.g. The Definitive Guide to Ratnapura Gems"
                  value={title}
            ...
            <CardContent className="space-y-4 text-xs">
              <div className="space-y-1.5">
                ...
                <Input
                  ...
                  placeholder="e.g. guide-to-ratnapura-gems"
                />
                {isDuplicateSlug ? (
